...
const RejectedUser = () => {
  ...
  let activeUsers = registrationData.filter((items) => items.status === "Rejected");
  ...
  return (
    <div className="relative overflow-x-auto">
      {token.permissions.find((p) => p.name === "Rejected User").permissions
        .fullAccess && (
      ...
      >
        <thead className="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            {token.permissions.find((p) => p.name === "Rejected User")
