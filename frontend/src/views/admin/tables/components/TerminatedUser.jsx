...
const TerminatedUser = () => {
  ...
  let activeUsers = registrationData.filter((items) => items.status === "Terminated");
  let newData = activeUsers?.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
  ...
  return (
    <div className="relative overflow-x-auto">
      {token.permissions.find((p) => p.name === "Terminated User")?.permissions
        .fullAccess && (
